...
class ResultFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (selectDate != null && selectFruit != null && resultAmount != null) {
            ...
            /* 에러가 발생한다면 toast를 이용하여 에러를 띄웁니다.*/
            ...
            /*  리사이클러뷰에 구분선 설정 */
            view.recycle_reesult.addItemDecoration(
            ...
            view.recycle_reesult.adapter = resultAdpater
            view.recycle_reesult.layoutManager = LinearLayoutManager(requireContext())
