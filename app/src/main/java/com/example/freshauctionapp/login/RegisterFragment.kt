...
class RegisterFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.btn_register.setOnClickListener {
            ...
            val id = view.field_register_id.text.toString()
            val pw = view.field_register_pw.text.toString()
            val pw_firm = view.field_register_pw_confirm.text.toString()
                    ...
                    firebaseAuth.createUserWithEmailAndPassword(id, pw)
                        .addOnCompleteListener { task ->
                            ...
                            task.addOnSuccessListener {
                                //입력 필드 초기화
                                view.field_register_id.text = null
                                view.field_register_pw.text = null
                                view.field_register_pw_confirm.text = null
